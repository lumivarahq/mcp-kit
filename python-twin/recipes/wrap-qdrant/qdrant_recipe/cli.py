"""Entry point: load config from the environment, build, and run.
    ...
    MCP_TRANSPORT=stdio QDRANT_URL=http://127.0.0.1:6333 python -m qdrant_recipe.cli
    MCP_TRANSPORT=http MCP_AUTH_TOKEN=secret python -m qdrant_recipe.cli

Mirrors ``mcp_kit_starter.cli``.
"""
